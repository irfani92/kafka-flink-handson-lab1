...
import demokafka.watermark.CustomWatermarkGenerator;
...
//    String alertTopic = "fraud-alert-transaction-topic";
 ...
 //   stream.print();
    ...
    DataStream<Transaction> transactionDataStream = stream.map(value -> objectMapper.readValue(value, Transaction.class))
  ...
  private static void processInsertTransaction(DataStream<Transaction> transactionDataStream) {
    ...
    JdbcConnectionOptions jdbcConnectionOptions = new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
        .withUrl("jdbc:mariadb://localhost:3306/testdb?useUnicode=true&characterEncoding=UTF-8&useSSL=false")
